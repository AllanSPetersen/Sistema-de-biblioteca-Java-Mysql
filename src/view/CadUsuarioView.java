...
public class CadUsuarioView extends javax.swing.JFrame {
    ...
    private CadUsuarioController controller;
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Usuario ADM");
        ...
        tblSearch.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "CPF", "Genero", "Data de Nascimento", "Telefone", "Endereço", "Usuario"
            }
        ) {
        ...
        getAccessibleContext().setAccessibleName("Cadastro de Usuario");
