...
public class EmprestimoView extends javax.swing.JFrame {
    ...
    public JTextField getTxtIdLivro() {
        return txtIdBook;
    }

    public void setTxtIdLivro(JTextField txtIdBook) {
    ...
    private void initComponents() {
        ...
        tblLoans.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "ID do Usuario", "ID do Livro", "Emprestado na data", "Retornou na Data"
            }
        ) {
        ...
        panData.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Informações", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Ubuntu", 0, 14))); // NOI18N
        ...
        lblReturnDate.setText("Data do Retorno");
